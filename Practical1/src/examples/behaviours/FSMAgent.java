...
public class FSMAgent extends Agent {
	// State names
	private static final String STATE_A = "Awake";
	private static final String STATE_B = "Eating";
	private static final String STATE_C = "Sleeping";
	private static final String STATE_D = "Asleep";
	private static final String STATE_E = "Dead";
